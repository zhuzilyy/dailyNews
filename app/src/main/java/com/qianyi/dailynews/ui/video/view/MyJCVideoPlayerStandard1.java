 ...
 */
public class MyJCVideoPlayerStandard1 extends JCVideoPlayerStandard {
    public MyJCVideoPlayerStandard1(Context context) {
        super(context);
    }

    public MyJCVideoPlayerStandard1(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
