...
public class WithdrawalRecordAdapter extends BaseAdapter {
    ...
    public WithdrawalRecordAdapter(Context context, List<WithdrawalInfo> infoList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.tv_name.setText("微信提现");
        viewHolder.tv_time.setText(withdrawalInfo.getTime());
        viewHolder.tv_coinCount.setText("-"+withdrawalInfo.getFee()+"元");
        return view;
    }
