 ...
 */
public class JCVideoPlayerStandard2 extends JCVideoPlayer{
    ...
    public JCVideoPlayerStandard2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public int getLayoutId() {
        return R.layout.jc_layout_standard2;
    }
